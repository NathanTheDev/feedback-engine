...
function buildSegments(
  ...
  // Find all span positions and build a list of segments
    ...
    <div className="min-h-screen bg-[#1C1714] flex flex-col items-center p-8">
      ...
      <div className="w-full max-w-5xl mt-4">
        ...
        <div className="flex gap-6 items-start" ref={containerRef}>
          {/* Main content */}
          <div className="flex-1 bg-[#252019] rounded-3xl border border-[#2E2820] px-10 py-8">
                ...
                <div
                  className={`rounded-2xl border px-4 py-3 transition-all duration-200 ${
                    activeIndex === i
                      ...
                      : "border-[#2E2820] bg-[#252019] opacity-70 hover:opacity-100"
                  }`}
                >
